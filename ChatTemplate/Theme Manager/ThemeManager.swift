...
class ThemeManager {
    ...
    static func applyTheme(theme: Theme) {
        ...
        setSegmentedControl(controlBackground)
        setStepper(controlBackground)
    ...
    private static func setNavigationBar(_ theme: Theme) {
    ...
    private static func setTabBar(_ theme: Theme) {
    ...
    private static func setStepper(_ controlBackground: UIImage?) {
    ...
    private static func setSwitch(_ theme: Theme) {
        UISwitch.appearance().onTintColor = theme.mainColor.withAlphaComponent(0.3)
        UISwitch.appearance().thumbTintColor = theme.mainColor
    }
    
    private static func setSegmentedControl(_ controlBackground: UIImage?) {
